...
#   aos atributos nome e preco. Depois, inicie uma instância da classe Mercado passando um 
#   objeto produto como argumento e para finalizar execute o método comprar.
